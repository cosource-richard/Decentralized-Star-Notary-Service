...
//Importing openzeppelin-solidity ERC-721 implemented Standar
...
contract StarNotary is ERC721Full {
    ...
    // symbol: Is a short string like 'USD' -> 'American Dollar'
      constructor() ERC721Full("GalaxyItem", "GLX") public {}
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        if (tokenOwner1 == msg.sender) {
            sender = 1;
        }

         if (tokenOwner2  == msg.sender) {
            sender = 2;
        }
        require(sender > 0 , "You can't exchange a Star you don't own");
